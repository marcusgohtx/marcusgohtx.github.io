(function () {
  ...
  async function save() {
    ...
    const db=supabase.createClient(IKIGAI_SUPABASE.url,IKIGAI_SUPABASE.publishableKey); const {error}=await db.rpc('configure_ikigai_room',{p_code:roomCode,p_config:config});
